...
import 'package:app/BarCodeScan.dart';
import 'package:flutter/material.dart';
import 'package:camera/camera.dart';
import 'package:intl/intl.dart';
import 'package:path_provider/path_provider.dart';

List<CameraDescription> camerassss = [];
...
class _CameraSState extends State<CameraS> {
  ...
  void initState() {
    ...
    _controller = CameraController(camerassss[0], ResolutionPreset.medium);
                        ...
                        await _takePicture().then((String path) {
                          if (path != null) {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => BarCodeScan(path),
                              ),
                            );
                          }
                        });
